 ...
 * @since 4.0.0
 */
public abstract class RootSsoException extends Exception {
   ...
   */
  public RootSsoException(@NotNull final String code) {
      this.code = code;
  }
   ...
   */
  public RootSsoException(@NotNull final String code, final String msg) {
      super(msg);
      this.code = code;
  }
   ...
   */
  public RootSsoException(@NotNull final String code, final Throwable throwable) {
      super(throwable);
      this.code = code;
  }
  ...
  public final String getCode() {
      ...
      if (cause instanceof RootSsoException) {
        return ((RootSsoException) cause).getCode();
      }
      return this.code;
  }
